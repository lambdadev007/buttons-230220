...
import style from "../style/AddFileTabbar.module.scss";
...
const AddFileTabbar = () => {
    ...
    return (
        <div style={{display:'inline-block'}}>
            <ul className={classNames(style["tabbar"], isActive?style['open']:'')}>
                <li>
                    <svg>
                ...
                <li>
                    <div className={classNames(style["fileAdd"], isActive?style['open']:'')} onClick={toggle}>
                        <ul>
                            <li className={style["word"]}></li>
                            <li className={style["powerpoint"]}></li>
                            <li className={style["excel"]}></li>
                        </ul>
                        <div>
                            <span></span>
                        </div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" style={{display: 'none'}}>
                <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="dashboardIcon">
                    <g strokeLinecap="square" strokeLinejoin="miter" strokeWidth="2">
                        <path fill="none" strokeMiterlimit="10" d="M6.3,10C6.1,10.6,6,11.3,6,12" strokeLinecap="butt"></path>
                        <path fill="none" strokeMiterlimit="10" d="M18,12c0-3.3-2.7-6-6-6 c-0.7,0-1.4,0.1-2,0.3" strokeLinecap="butt"></path>
                        <line fill="none" strokeMiterlimit="10" x1="10.6" y1="10.6" x2="7" y2="7"></line>
                        <circle fill="none" strokeMiterlimit="10" cx="12" cy="12" r="2"></circle>
                        <circle fill="none" strokeMiterlimit="10" cx="12" cy="12" r="11"></circle>
                    </g>
                </symbol>
                ...
                <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="cameraIcon">
                    <g strokeLinecap="square" strokeLinejoin="miter" strokeWidth="2">
                        <rect x="1" y="5" transform="matrix(-1 -4.489621e-11 4.489621e-11 -1 24 27)" fill="none" strokeMiterlimit="10" width="22" height="17"></rect>
                        <line fill="none" strokeMiterlimit="10" x1="4" y1="2" x2="8" y2="2"></line>
                        <circle fill="none" strokeMiterlimit="10" cx="15" cy="14" r="4"></circle>
                        <circle cx="6" cy="10" r="1" strokeLinejoin="miter" strokeLinecap="square" stroke="none"></circle>
                    </g>
                </symbol>
                ...
                <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="filesIcon">
                    <g strokeLinecap="square" strokeLinejoin="miter" strokeWidth="2" transform="translate(1,0)">
                        <line x1="7" y1="7" x2="8" y2="7" fill="none" strokeMiterlimit="10"></line>
                        <line x1="12" y1="7" x2="17" y2="7" fill="none" strokeMiterlimit="10"></line>
                        <line x1="7" y1="12" x2="8" y2="12" fill="none" strokeMiterlimit="10"></line>
                        <line x1="12" y1="12" x2="17" y2="12" fill="none" strokeMiterlimit="10"></line>
                        <line x1="7" y1="17" x2="12" y2="17" fill="none" strokeMiterlimit="10"></line>
                        <polygon points="16 23 16 17 22 17 16 23" stroke="none" strokeLinecap="butt"></polygon>
                        <polyline points="16 23 16 17 22 17" fill="none" strokeMiterlimit="10" strokeLinecap="butt"></polyline>
                        <polygon points="16 23 2 23 2 1 22 1 22 17 16 23" fill="none" strokeMiterlimit="10"></polygon>
                    </g>
                </symbol>
                ...
                <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="userIcon">
                    <g strokeLinecap="square" strokeLinejoin="miter" strokeWidth="2">
                        <path fill="none" strokeMiterlimit="10" d="M12,12L12,12 c-2.761,0-5-2.239-5-5V6c0-2.761,2.239-5,5-5h0c2.761,0,5,2.239,5,5v1C17,9.761,14.761,12,12,12z"></path>
                        <path fill="none" strokeMiterlimit="10" d="M22,20.908 c0-1.8-1.197-3.383-2.934-3.856C17.172,16.535,14.586,16,12,16s-5.172,0.535-7.066,1.052C3.197,17.525,2,19.108,2,20.908V23h20 V20.908z"></path>
                    </g>
                </symbol>
