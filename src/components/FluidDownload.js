...
import style from "../style/FluidDownload.module.scss";
...
const ButtonGrid = () => {
    ...
    const onclick = (e) => {
        e.preventDefault();
        setIsActive(true);
        setTimeout(()=>setIsActive(false), 4200);
    }
    return (
        <div style={{display:'inline-block'}}>
            <div className={classNames(style["upload"], isActive?style['loading']:'')} onClick={(e)=>onclick(e)}>
                <div className={style["path"]}>
                    <div className={style["arrow"]}></div>
                    <svg>
                        <use xlinkHref="#path-fluid" />
                    </svg>
                </div>
                <div className={style["circle"]}>
                    <div className={style["water"]}>
                        <svg>
                            <use xlinkHref="#wave-fluid" />
                        </svg>
                        <svg>
                            <use xlinkHref="#wave-fluid" />
                        </svg>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" style={{display: 'none'}}>
                <symbol viewBox="0 0 72 72" id="path-fluid">
                ...
                <symbol viewBox="0 0 116 6" id="wave-fluid">
